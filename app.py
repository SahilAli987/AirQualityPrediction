...
from prediction import show_predict_page, show_geo_prediction_page, show_india_aqi_map
...
page = st.sidebar.selectbox("Menu", ("Predict", "Geo Location", "India AQI Map", "Explore"))
